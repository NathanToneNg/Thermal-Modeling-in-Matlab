...
Tempgrid = zeros(xintervals, yintervals, zintervals) + initialRoomTemp;
switch elevLocation 
    case 1
        %Center ixel
...
%% Room Temp differences

%initialRoomTemp = roomTemp; %Declared earlier for tempgrid assigning

% Changes in convection and radiation places, and in the iteration
