...
finalGrid = 1;
global finalTemps
load GaussTest3DSuccessPrecise1finalTemps
global framerate
framerate = 2000;
global frequency2
frequency2 = 12;
...
isotherm = 1;
global list
list = '0.912       0.912       0.912       0.912       0.912       0.912       0.912       0.912       0.912       0.912';
list = str2num(list);
global materialMatrix
load GaussTest3DSuccessPrecise1materialMatrix
global materials
materials = 1;
global melting
melting = 0;
...
specific_heat2 = 4130;
global tempsList
tempsList = '0.0005      0.0005      0.0005      0.0005      0.0005      0.0005      0.0005      0.0005      0.0005      0.0005';
...
f = fit(x,finalTemps(:,50,50),'gauss1');
